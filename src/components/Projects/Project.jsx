        ...
        <div className="project">
            ...
            <div className="project-img-wrapper-cover">
                ...
                <Suspense fallback={<div>Loading...</div>}>
                    <LazyLoadedImage src={getImgUrl(id, "1.webp")} alt="Description" />
                </Suspense>
            </div>

            <div className="project-imgs-wrapper">
                <Suspense fallback={<p>Loading</p>}>
                    <LazyLoadedVideo src={getImgUrl(id, "video.mp4")} alt="Description" />
                </Suspense>
                ...
                <div>
                    <Suspense fallback={<div>Loading...</div>}>
                        <LazyLoadedImage src={getImgUrl(id, "2.webp")} alt="Description" />
                    </Suspense>
                </div>
             
                <div>
                    <Suspense fallback={<div>Loading...</div>}>
                        <LazyLoadedImage src={getImgUrl(id, "3.webp")} alt="Description" />
                    </Suspense>
                </div>
            </div>
