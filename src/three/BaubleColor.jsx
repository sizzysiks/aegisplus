...
export default function BaubleColor({ vec = new THREE.Vector3(), scale = [0.75, 0.75, 1, 1, 1.25][Math.floor(Math.random() * 5)], r = THREE.MathUtils.randFloatSpread, color, geometry }) {
    ...
    <RigidBody linearDamping={0.75} angularDamping={0.15} friction={0.2} position={[r(20), r(20) - 25, r(20) - 10]} ref={api} colliders={false} dispose={null}>
      ...
      <mesh scale={scale} geometry={geometry} material={baubleMaterial} />
    </RigidBody>
    )
}